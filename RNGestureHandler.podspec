...
Pod::Spec.new do |s|
  ...
  package = JSON.parse(File.read(File.join(File.dirname(__FILE__), 'react-native-gesture-handler', "package.json")))
  ...
  s.source_files = "react-native-gesture-handler/ios/**/*.{h,m}"
