...
header_subspecs = {
  ...
  'RCTActionSheetHeaders'       => 'ActionSheetIOS/*.h',
  'RCTAnimationHeaders'         => 'NativeAnimation/{Drivers/*,Nodes/*,*}.{h}',
  'RCTBlobHeaders'              => 'Blob/{RCTBlobManager,RCTFileReaderModule}.h',
  'RCTImageHeaders'             => 'Image/*.h',
  'RCTLinkingHeaders'           => 'LinkingIOS/*.h',
  'RCTNetworkHeaders'           => 'Network/*.h',
  'RCTPushNotificationHeaders'  => 'PushNotificationIOS/*.h',
  'RCTSettingsHeaders'          => 'Settings/*.h',
  'RCTTextHeaders'              => 'Text/**/*.h',
  'RCTVibrationHeaders'         => 'Vibration/*.h',
}
